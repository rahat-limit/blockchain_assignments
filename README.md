...
**In order to deploy token on MetaMask, I connected wallet to BSC test network. Then connected remix with metamask. Consequently, I had everything to go on. /n To test my token, transaction was sent. Finally, it succeeded!**
